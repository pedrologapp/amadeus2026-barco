          ...
          <Card className="mb-8">
            ...
            <CardContent>
              ...
              <div className="text-center">
                <div className="inline-flex items-center justify-center gap-2 px-8 py-3 bg-red-100 border-2 border-red-300 rounded-lg">
                  <XCircle className="h-5 w-5 text-red-600" />
                  <span className="text-lg font-bold text-red-700">Vagas Preenchidas</span>
                </div>
                <p className="text-xs text-muted-foreground mt-2">
                  Todas as vagas para este evento foram preenchidas. Em caso de dúvidas, entre em contato com a escola.
                </p>
              </div>
            </CardContent>
          </Card>
